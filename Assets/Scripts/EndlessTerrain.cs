...
public class EndlessTerrain : MonoBehaviour {
    ...
    public static float maxViewDstSqrt;
    ...
    void Start() {
        ...
        maxViewDstSqrt = detailLevels[detailLevels.Length - 1].visibleDstThreshold;

        chunkSize = MapGenerator.mapChunkSize - 1;
        chunksVisibleInViewDst = Mathf.RoundToInt(Mathf.Sqrt(maxViewDstSqrt) / chunkSize);

        //Debug.Log("Starting endless terrain with maxViewDstSqrt: " + maxViewDstSqrt + ", chunkSize: " + chunkSize + ", chunksVisibleInViewDst: " + chunksVisibleInViewDst);
    ...
    public class TerrainChunk {
        ...
        public void UpdateTerrainChunk() {
            ...
            bool visible = viewerDstFromNearestEdge <= maxViewDstSqrt;
